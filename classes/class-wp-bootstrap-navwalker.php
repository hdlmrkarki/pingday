...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			//if(get_field('enable_two_column', $item))
			if($depth==0){
				$mega_menu = '<div class="mega-menu-container">';
			}

			$output .= "{$n}{$indent}<span class='submenu-opener level_$depth'></span><div $class_names>$mega_menu<ul >{$n}";
		}
